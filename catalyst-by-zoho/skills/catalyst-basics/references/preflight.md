...
> **Codex execution approval:** `catalyst init` links the workspace to a remote Catalyst project and
> writes CLI project/config files. Request escalated execution before running it, explaining that it
